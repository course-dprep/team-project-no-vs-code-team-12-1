...
![Figure 2.3.1.1 Boxplots](../7-plots/figure_1_boxplots.png){fig-align="center"}

![Figure 2.3.1.1 Histograms](../7-plots/figure_2_histograms.png){fig-align="center"}
...
regression_summary <- summary(takeout_lm1)
```

...
To make it easier for analysis, we decided to encode the values in the "**elite**" column by creating a new column 'elite_label_encoder' to identify influential users. The logic is 
  - If the 'elite' column is "NA" or an empty string, set 'elite_label_encoder' to 0 (not influential user)
  - If the 'elite' column has a value, set 'elite_label_encoder' to 1 (influential user).
